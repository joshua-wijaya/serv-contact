...

{
  ...
  public function getRecords(){
    //will develop authentication later

    $InquiryModel = new InquiryModel();
    $query = "select id_pk_inquiry, inquiry_nama, inquiry_email, inquiry_perusahaan, inquiry_subject, inquiry_message, created_at, updated_at from inquiry order by updated_at DESC";
    $res = $InquiryModel->query($query)->getResultArray();
    // $res = $InquiryModel->findAll();
